...
import { Avatar, Form, Modal, Upload, message, Input, FormInstance } from "antd";
...
const PhotoUpload = (props: Props) => {
  ...
  return (
    <>
      ...
      >
        <Cropper cropShape={props.isAvatar ? "round" : "rect"} aspect={props.isAvatar ? 1 : 16 / 9} beforeCrop={beforeUpload}>
          <Upload
            id="image"
            ...
            action={props.action ? props.action : "http://localhost:5000/api/v1/upload"}
            headers={{
